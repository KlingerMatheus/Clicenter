...
const PatientLayoutContent: React.FC<{ children: React.ReactNode; title: string }> = ({ children, title }) => {
...
const PatientLayout: React.FC<PatientLayoutProps> = ({ children, title = 'Paciente' }) => {
    return (
        <ThemeProvider>
            <SidebarProvider userType="paciente">
                <Suspense fallback={<ContentLoading />}>
                    <PatientLayoutContent title={title}>
                        {children}
