...
const ConsultationsPage: React.FC = () => {
            ...
            const mockConsultations: Consultation[] = [
                {
                    ...
                    notes: 'Consulta realizada com sucesso. Paciente apresentou melhora dos sintomas.',
    ...
    const getStatusIcon = (status: string) => {
        switch (status) {
            ...
            case 'confirmed': return <PendingIcon />;
                        ...
                        <Box sx={{ pt: 2 }}>
                            <Paper sx={{ p: 3, mb: 3, bgcolor: theme.palette.mode === 'dark' ? 'grey.800' : 'grey.50' }}>
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                        <Typography variant="body2">
                                            <strong>Telefone:</strong> {selectedConsultation.doctorPhone}
                                        </Typography>
                                    </Grid>
                                    <Grid item xs={12} sm={6}>
                                        <Typography variant="body2">
                                    ...
                                    {selectedConsultation.notes && (
                                        <Grid item xs={12}>
                                            <Typography variant="body2">
                                                <strong>Observações:</strong> {selectedConsultation.notes}
                                            </Typography>
                                        </Grid>
                                    )}
                                    ...
                                    {selectedConsultation.prescription && (
                                        <Grid item xs={12}>
                                            <Typography variant="body2">
                                                <strong>Prescrição:</strong> {selectedConsultation.prescription}
                                            </Typography>
                                        </Grid>
                                    )}
                                </Grid>
