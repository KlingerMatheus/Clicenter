    ...
    return (
        <Box sx={{ p: 3 }}>
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} sm={4}>
                                <TextField
                                    ...
                                    disabled={!editing}
                                    InputProps={{
                                        startAdornment: <BloodIcon sx={{ mr: 1, color: 'action.active' }} />
                                    }}
                                />
                            </Grid>
                            <Grid item xs={12} sm={4}>
                    ...
                    <Stack spacing={3}>
                        ...
                        <Paper sx={{
                            ...
                            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                                {calculateAge(profile.dateOfBirth)} anos • {profile.gender === 'male' ? 'Masculino' :
                        ...
                        <Paper sx={{
                            ...
                            <Stack spacing={1}>
                                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    ...
                                    <Chip
                                        label={formData.preferences.notifications ? 'Ativadas' : 'Desativadas'}
                                        size="small"
                                ...
                                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    ...
                                    <Chip
                                        label={formData.preferences.emailNotifications ? 'Ativado' : 'Desativado'}
                                        size="small"
                                        color={formData.preferences.emailNotifications ? 'success' : 'default'}
                                    />
                                </Box>
                                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <Typography variant="body2">SMS</Typography>
                                    <Chip
                                        label={formData.preferences.smsNotifications ? 'Ativado' : 'Desativado'}
                                        size="small"
                                        color={formData.preferences.smsNotifications ? 'success' : 'default'}
                                    />
                                </Box>
                            </Stack>
                        </Paper>
            ...
            <Dialog open={openEmergencyDialog} onClose={() => setOpenEmergencyDialog(false)} maxWidth="sm" fullWidth>
                ...
                <DialogActions>
                    <Button onClick={() => setOpenEmergencyDialog(false)}>Cancelar</Button>
