...
const ScheduleConsultationPage: React.FC = () => {
    ...
    const availableDates = selectedDoctor
        ? Array.from(new Set(selectedDoctor.availableSlots
    ...
    return (
        <Box sx={{ p: 3 }}>
                                                    ...
                                                    <Box component="div">
                                                        ...
                                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mt: 0.5 }}>
                                                            <Typography variant="caption" color="text.secondary" component="div">
                                                                ⭐ {doctor.rating} ({doctor.totalConsultations} consultas)
                                                            </Typography>
                                                        </Box>
                                                    </Box>
                                                }
                ...
                <Grid item xs={12}>
                    <Paper sx={{
                        ...
                        {selectedDoctor && selectedDate && selectedTime && (
                            <Box sx={{ mt: 3, p: 2, bgcolor: theme.palette.mode === 'dark' ? 'grey.700' : 'grey.50', borderRadius: 2 }}>
                        ...
                        <Box sx={{ mt: 3, display: 'flex', justifyContent: 'flex-end' }}>
                            <Button
                                ...
                                disabled={!selectedDoctor || !selectedDate || !selectedTime || !symptoms.trim()}
                            >
                                Agendar Consulta
                            </Button>
                        </Box>
            ...
            <Dialog open={openConfirmation} onClose={() => setOpenConfirmation(false)} maxWidth="sm" fullWidth>
                ...
                <DialogContent>
                    {selectedDoctor && (
                        <Box sx={{ pt: 2 }}>
                            ...
                            <Paper sx={{ p: 2, bgcolor: theme.palette.mode === 'dark' ? 'grey.700' : 'grey.50' }}>
                                <Grid container spacing={2}>
                                    <Grid item xs={12}>
                                        <Typography variant="subtitle2" sx={{ fontWeight: 600 }}>
                ...
                <DialogActions>
                    <Button onClick={() => setOpenConfirmation(false)} disabled={submitting}>
                        Cancelar
                    </Button>
                    <Button
