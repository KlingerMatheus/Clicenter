...
import { Event, MedicalServices, Schedule, Person, People, PersonAdd, PersonOff } from '@mui/icons-material';
        ...
        <Box sx={{ p: 3 }}>
            ...
            <Paper sx={{
                ...
                <Typography variant="body1" color="text.secondary">
                    Use o menu lateral para acessar suas informações e funcionalidades.
                </Typography>
            </Paper>
        </Box>
    );
