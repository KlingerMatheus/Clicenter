        ...
        <Box sx={{ p: 3 }}>
            ...
            <Paper sx={{
                ...
                <Typography variant="body1" color="text.secondary">
                    Aqui você pode acompanhar suas consultas, visualizar seu histórico médico e gerenciar suas informações de saúde.
                    Use o menu lateral para acessar todas as funcionalidades disponíveis.
                </Typography>
            </Paper>
            ...
            <Grid container spacing={3} sx={{ mt: 1 }}>
                <Grid item xs={12} md={6}>
                    <Paper sx={{
                        ...
                        {consultations.filter(c => c.status === 'scheduled' || c.status === 'confirmed').length === 0 ? (
