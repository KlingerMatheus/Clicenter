...
import { Event, People, MedicalServices, Schedule, PersonAdd, PersonOff } from '@mui/icons-material';
        ...
        <Box sx={{ p: 3 }}>
            ...
            <Paper sx={{
                ...
                <Typography variant="body1" color="text.secondary">
                    Use o menu lateral para gerenciar pacientes e acessar outras funcionalidades.
                </Typography>
            </Paper>
        </Box>
    );
