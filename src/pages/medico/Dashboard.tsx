...
import { Box, Typography, Paper, Grid, Card, CardContent, Chip, Avatar, useTheme } from '@mui/material';
import {
    Event as EventIcon,
...
const Dashboard: React.FC = () => {
    ...
    const getTypeLabel = (type: string) => {
        switch (type) {
            ...
            case 'upcoming': return 'Próximos Dias';
        ...
        <Box sx={{ p: 3 }}>
                                    ...
                                    <Box sx={{ mb: 2 }}>
                                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                            ...
                                            <Typography variant="subtitle2" sx={{ fontWeight: 600 }}>
                                                {typeReminders.length} consulta{typeReminders.length > 1 ? 's' : ''}
                                            </Typography>
                                        </Box>
                                                        ...
                                                        <CardContent sx={{ pl: 2, pr: 2, py: 2 }}>
                                                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 1.5 }}>
                                                                <Avatar sx={{
                                                                    ...
                                                                    {reminder.patientName.split(' ').map(n => n[0]).join('').toUpperCase()}
                                                                </Avatar>
            ...
            <Paper sx={{
                ...
                <Typography variant="body2" color="text.secondary">
                    • Use o menu lateral para acessar suas consultas e pacientes<br />
                    • Você pode reagendar consultas diretamente na página de consultas<br />
                    • Mantenha os relatórios médicos sempre atualizados<br />
                    • Verifique regularmente os lembretes de consultas
                </Typography>
            </Paper>
        </Box>
    );
