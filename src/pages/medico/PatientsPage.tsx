...
const PatientsPage: React.FC = () => {
    ...
    const [dialogType, setDialogType] = useState<'view' | 'edit' | 'history'>('view');
                    ...
                    medicalHistory: [
                        {
                            ...
                            notes: 'Paciente relatou dor de cabeça persistente há 3 dias. Recomendado evitar estresse.',
                    ...
                    medicalHistory: [
                        {
                            ...
                            notes: 'Paciente com histórico de gastrite. Recomendado evitar alimentos ácidos.',
                            doctor: 'Dr. Carlos Mendes'
                        }
                    ],
                    consultations: [
                    ...
                    medicalHistory: [
                        {
                            ...
                            notes: 'Paciente com dor lombar intensa. Encaminhado para fisioterapia.',
                            doctor: 'Dr. Carlos Mendes'
                        }
                    ],
                    consultations: [
                    ...
                    medicalHistory: [
                        {
                            ...
                            notes: 'Paciente com pressão arterial elevada. Acompanhamento mensal necessário.',
                            doctor: 'Dr. Carlos Mendes'
                        }
                    ],
                    consultations: [
    ...
    const handleOpenDialog = (patient: Patient, type: 'view' | 'edit' | 'history') => {
            ...
            <Table>
                <TableHead>
                    <TableRow sx={{ backgroundColor: theme.palette.primary.main }}>
                        ...
                        <TableCell sx={{ color: 'white', fontWeight: 600 }}>Idade</TableCell>
                        <TableCell sx={{ color: 'white', fontWeight: 600 }}>Contato</TableCell>
                        <TableCell sx={{ color: 'white', fontWeight: 600 }}>Tipo Sanguíneo</TableCell>
                        <TableCell sx={{ color: 'white', fontWeight: 600 }}>Consultas</TableCell>
                        <TableCell sx={{ color: 'white', fontWeight: 600 }}>Registros</TableCell>
                    ...
                    {patients.map((patient) => (
                        <TableRow key={patient._id} hover>
                            ...
                            <TableCell>
                                ...
                                <Typography variant="caption" color="text.secondary">
                                    {patient.consultations.filter(c => c.status === 'completed').length} concluídas
                                </Typography>
                            </TableCell>
                            <TableCell>
                                <Typography variant="body2">
                                    ...
                                    <Grid item xs={12}>
                                        <Paper sx={{ p: 3, bgcolor: theme.palette.mode === 'dark' ? 'grey.800' : 'grey.50' }}>
                                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                                                <Avatar sx={{ mr: 2, width: 64, height: 64, bgcolor: theme.palette.primary.main }}>
                                                ...
                                                <Box>
                                                    ...
                                                    <Typography variant="body2" color="text.secondary">
                                                        Paciente desde {formatDate(selectedPatient.createdAt)}
                                                    </Typography>
                                                </Box>
                                            </Box>
                                            ...
                                            <Grid container spacing={3}>
                                                <Grid item xs={12} md={6}>
                                                    ...
                                                    <Stack spacing={1}>
                                                        ...
                                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                                            <CalendarIcon fontSize="small" color="action" />
                                                            <Typography variant="body2">
                                                                {formatDate(selectedPatient.dateOfBirth)} ({calculateAge(selectedPatient.dateOfBirth)} anos)
                                                            </Typography>
                                                        </Box>
                                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                                ...
                                                <Grid item xs={12}>
                                                    ...
                                                    <Paper sx={{ p: 2, bgcolor: theme.palette.mode === 'dark' ? 'grey.700' : 'white' }}>
                            ...
                            {dialogType === 'history' && (
                                <Box>
                                    ...
                                    {activeTab === 1 && (
                                        <Box>
                                            <Typography variant="h6" sx={{ mb: 2 }}>
                                                Histórico Médico ({selectedPatient.medicalHistory.length})
                                            </Typography>
