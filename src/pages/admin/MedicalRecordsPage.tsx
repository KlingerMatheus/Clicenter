                ...
                const mockData: MedicalRecord[] = [
                    {
                        ...
                        notes: 'Paciente apresentou pressão arterial elevada. Recomendado controle de sal e exercícios físicos.',
                        status: 'active'
                    },
                    {
                        _id: '2',
                        ...
                        notes: 'Sintomas leves, sem complicações. Recomendado repouso e hidratação.',
                        status: 'resolved'
                    },
                    {
                        _id: '3',
                        ...
                        notes: 'Paciente diagnosticado com diabetes. Iniciado tratamento e orientações sobre dieta.',
                        status: 'follow_up'
                    }
                ];
            ...
            <CardContent>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
                    ...
                    <Typography variant="body2">
                        <strong>Paciente:</strong> {record.patient.name} ({calculateAge(record.patient.dateOfBirth)} anos)
                    </Typography>
                </Box>
                            ...
                            <TableCell>
                                <Box>
                                    ...
                                    <Typography variant="caption" color="text.secondary">
                                        {calculateAge(record.patient.dateOfBirth)} anos • {record.patient.email}
                                    </Typography>
                                </Box>
                            </TableCell>
                            <TableCell>
                        ...
                        <DialogContent>
                            <Box sx={{ mt: 2 }}>
                                ...
                                <Box sx={{ mb: 3 }}>
                                    ...
                                    <Typography variant="body2">
                                        <strong>Idade:</strong> {calculateAge(selectedRecord.patient.dateOfBirth)} anos
                                    </Typography>
                                </Box>
                                ...
                                <Box sx={{ mb: 3 }}>
                                    <Typography variant="body2">
                                        <strong>Data:</strong> {formatDate(selectedRecord.consultationDate)}
                                    </Typography>
                                    <Typography variant="body2">
