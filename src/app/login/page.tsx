      ...
      >
        ...
        <Paper
          ...
          sx={{
            ...
            border: {
              xs: 'none',
              md: `1px solid ${theme.palette.mode === 'dark' ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.1)'}`,
            },
            boxShadow: {
              xs: 'none',
        ...
        >
          <Box sx={{ mb: { xs: 3, md: 4 } }}>
            ...
            >
              ...
              >
                <HealthIcon
                  sx={{ fontSize: { xs: 28, md: 32 }, color: 'white' }}
                />
              </Box>
            </Box>
        ...
        <Dialog
          ...
          PaperProps={{
            sx: {
              ...
              border: {
                xs: 'none',
                sm: `1px solid ${theme.palette.mode === 'dark' ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.1)'}`,
              },
              boxShadow: {
                xs: 'none',
        ...
        >
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              ...
              >
                <HealthIcon
                  sx={{ fontSize: { xs: 16, sm: 18 }, color: 'white' }}
                />
              </Box>
